<template>
  <div>
    <!-- 复制 index.html 的 12 ~ 56 -->
    <!--banner-->
    <div class="banner">
      <!-- 练习：编写banner的html和css-->
      <!-- 图片列表-->
      <ul>
        <!-- 内联样式写法中的图片,必须用require关键词引入才可以 -->
        <!-- :style="{属性名:值, 属性名:值}" -->
        <!-- :style="{background: 'xx'+require()+'xxx' }" -->
        <li
          :style="{background: 'url('+ require('../assets/images/banner_01.jpg') + ') center 0 no-repeat', 
          display: 'block',
          'z-index': 20}"
        >
          <a href="#" class="link"></a>
        </li>
        <li style="background: url(images/banner_02.jpg) center 0 no-repeat;">
          <a href="#" class="link"></a>
        </li>
        <li style="background: url(images/banner_03.jpg) center 0 no-repeat;">
          <a href="#" class="link"></a>
        </li>
        <li style="background: url(images/banner_04.jpg) center 0 no-repeat;">
          <a href="#" class="link"></a>
        </li>
      </ul>
      <!-- 左右箭头-->
